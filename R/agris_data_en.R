...
#'
#' @examples
agrisdata_en <- function(shpfile, level=3,
  ...
  data=final_points %>% dplyr::bind_cols(wakefield::r_data_frame(
    ...
    Q12c=wakefield::r_sample(x=c("Male","Female"),prob = c(0.8,0.20)),
    ...
    labelled::set_variable_labels(
      ...
      Q21d="What are the other administrative identification numbers of the holding?-Other (specify",
